...
* Utilisation de l’interpolation pour remplir certaines valeurs manquantes tout en respectant la tendance réelle des données.
...
## 💾 Exportation des Données vers MySQL

### 1. Préparation des données

* Après le calcul des différents KPI, les colonnes nécessaires ont été ajoutées au dataframe `wbd`, et les colonnes inutiles ont été supprimées.
* Les dataframes finaux ont été exportés en CSV à l’aide de :
...
#### Table `wbd` (avec champs pouvant contenir NULL)
...
### 4. Autoriser l’import local dans MySQL

Dans les paramètres de connexion MySQL, activer :

```
OPT_LOCAL_INFILE=1
```
<img width="660" height="441" alt="edit_connection_mysql" src="https://github.com/user-attachments/assets/906fd73a-3607-4e40-a750-b63ffb30a4e5" />

---

### 5. Importation des fichiers CSV dans MySQL
...
#### Import des données WBD (avec gestion des valeurs vides)
...
Une modélisation relationnelle simple est obtenue, reliant :

* `athletes` → NOC
* `wbd` → NOC
* `noc` → table de référence des pays/équipes

Cela forme un schéma en étoile cohérent pour les analyses entre performance olympique et indicateurs socio-économiques.

<img width="829" height="468" alt="image" src="https://github.com/user-attachments/assets/60038fa9-b2e6-4c8d-8f30-28386dc76f18" />


## 📈 Dashboard Final & Analyses Visuelles
